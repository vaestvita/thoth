...
def message_processing(request):
    ...
    value = changes['value']
    message_data['MESSAGES'][0]['chat']['id'] = value['metadata']['display_phone_number']
    ...
    try:
        ...
        return Response({"error": "Phone with given phone_number_id not found"}, status=status.HTTP_400_BAD_REQUEST)
    ...
    for message in messages:
        ...
        if message_type == "text":
            ...
            message_data['MESSAGES'][0]['message']['text'] = media_data.get('caption', f'{filename}') 
